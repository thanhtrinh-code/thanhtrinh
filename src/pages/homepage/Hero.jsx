...
export default function Hero() {
  return (
    <div className='w-full h-2/3 sm:h-full bg-inherit text-white flex justify-center items-center'>
      <motion.div 
  ...
  >
    ...
    />
      ...
      <motion.div
        ...
        animate={{ y: 0, opacity: 1 }}   // Move up and fade in
        transition={{ type: "spring", stiffness: 50, damping: 10, duration: 10 }}
        className='w-full h-full bg-inherit flex sm:hidden justify-center items-center'
        >
          <div className='w-[90%] h-[28rem] bg-white'>
            Hello World
          </div>
      </motion.div>
    </div>
